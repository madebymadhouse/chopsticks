      ...
      <div className="footer-inner">
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <p>An open source Discord bot built by Mad House and the Mad House community. MIT licensed.</p>
          </div>
        ...
        <div className="footer-bottom">
          <p>Built by <a href="https://github.com/Mad House" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-muted)', textDecoration: 'underline', textUnderlineOffset: '3px' }}>Mad House</a> &amp; Mad House · {new Date().getFullYear()}</p>
